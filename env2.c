...
/**
* _setenv - Sets an environment variable with the provided name and value.
* @datash: Data relevant to the shell (environment variable name and value)
* Return: 1 on success.
*/
...
* @datash: Data relevant to the shell (environment variable name)
* Return: 1 on success.
*/
