...
* Return: 1 if the path contains a ':', 0 otherwise.
*/
...
/**
* check_error_cmd - Checks if a user has permissions to access a directory.
...
* @datash: Data relevant to command execution (arguments and input).
* Return: 1 on success.
*/
